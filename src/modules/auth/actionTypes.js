...
export const AUTH_UPDATE_OTP_FORM_FIELD = 'AUTH_UPDATE_OTP_FORM_FIELD';
export const AUTH_SUBMIT_OTP_FORM = 'AUTH_SUBMIT_OTP_FORM';
export const AUTH_INVALIDATE_OTP_FORM = 'AUTH_INVALIDATE_OTP_FORM';
export const AUTH_RESET_OTP_FORM_FIELDS = 'AUTH_RESET_OTP_FORM_FIELDS';  

export const AUTH_SUBMIT_CHANGE_PASSWORD_FORM = 'AUTH_SUBMIT_CHANGE_PASSWORD_FORM';
export const AUTH_UPDATE_CHANGE_PASSWORD_STATUS_FIELD = 'AUTH_UPDATE_CHANGE_PASSWORD_STATUS_FIELD';
export const AUTH_INVALIDATE_CHANGE_PASSWORD_FORM = 'AUTH_INVALIDATE_CHANGE_PASSWORD_FORM';
export const AUTH_RESET_CHANGE_PASSWORD_FORM = 'AUTH_RESET_CHANGE_PASSWORD_FORM';
export const AUTH_UPDATE_CHANGE_PASSWORD_FORM_FIELD = 'AUTH_UPDATE_CHANGE_PASSWORD_FORM_FIELD';
...
export const APP_LEVEL_CONFIG = 'APP_LEVEL_CONFIG';
